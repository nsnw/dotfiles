...
SPACESHIP_TIME_COLOR="${PROMPT_BG_1}%F{39}"
...
SPACESHIP_VENV_PREFIX="${PROMPT_BG_1}%F{22}[%F{34}venv:%F{154}"
...
# Exec time
SPACESHIP_EXEC_TIME_PREFIX="%K{220}%F{236} "
SPACESHIP_EXEC_TIME_SUFFIX="%K{220} "
SPACESHIP_EXEC_TIME_COLOR=236

# Exit code
SPACESHIP_EXIT_CODE_SHOW=true
SPACESHIP_EXIT_CODE_PREFIX="%{%K{160}%F{15}%} "
...
SPACESHIP_USER_COLOR="%F{84}"
SPACESHIP_USER_PREFIX="%k%F{235}\n${PROMPT_BG_3}%F{45} "
...
SPACESHIP_HOST_SUFFIX="%K{24} ${PROMPT_BG_1} "
...
SPACESHIP_GIT_BRANCH_PREFIX="${PROMPT_BG_2}%F{58}[%F{214}"
SPACESHIP_GIT_BRANCH_SUFFIX=" "
SPACESHIP_GIT_BRANCH_COLOR="%B%F{214}"
