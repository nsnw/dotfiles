...
SPACESHIP_VENV_PREFIX="${PROMPT_BG_2} %F{39}• %F{34}v:%F{154}"
SPACESHIP_VENV_SUFFIX="${PROMPT_BG_2}%F{22}"
...
SPACESHIP_CHEF_PREFIX="${PROMPT_BG_2} %F{39}• %F{166}chef:%F{172}"
SPACESHIP_CHEF_SUFFIX="${PROMPT_BG_2}"
...
SPACESHIP_DIR_PREFIX="${PROMPT_BG_1} 🌈 %{%k%F{236}%}\n%K{24}${PROMPT_BG_2}%F{24}▌"
...
SPACESHIP_USER_SUFFIX="${PROMPT_BG_3}%k%F{234}"

# Char
SPACESHIP_CHAR_SYMBOL="$ "
SPACESHIP_CHAR_SYMBOL_ROOT="%F{196}#"
...
# AWS
SPACESHIP_AWS_PREFIX="${PROMPT_BG_1} %F{39}• %F{208}"
